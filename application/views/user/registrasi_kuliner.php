...
<head>
        <title>SIWIKODE - Registrasi Kuliner</title>
    ...
    <body style="background-color: #F0F5F8; font-family: Arial, Helvetica;">
        ...
        <div class="tombol">
                <button class="button1"><a href="<?php echo base_url()?>index.php/welcome/reg_wis">Wisata</a></button>
                <button class="button2"><a href="<?php echo base_url()?>index.php/welcome/reg_kul">Kuliner</a></button>
            </div>

            <div class="Title1">Form Registrasi Tempat Rekreasi Kuliner</div>
            ...
            <form action="/action_page.php">
                ...
                <div class="Box">
                    ...
                    <option value="australia">Makanan Kenyang</option>
                    <option value="canada">Cemilan</option>
                    <option value="usa">Minuman</option>
                    </select>
                </div>
